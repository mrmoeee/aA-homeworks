...
// titleize should use Array.prototype.map to create a new array full of titleized versions of each name - titleize meaning "Roger" should be made to read "Mx. Roger Jingleheimer Schmidt". Then pass this new array of names to the callback, which should use Array.prototype.forEach to print out each titleized name.
//
...
function titleize(array, callback) {
  let titleized = array.map(ele => `Mx ${ele} Jingleheimer Schmidt`);
  callback(titleized);
};
...
// First write a constructor function for an elephant. Each elephant should have a name,
//height (in inches),
...
let phanty = new Elephant("Phanty", 12, ["painting a picture", "flying high", "dancing."]);
// phanty.trumpet();
// phanty.grow();
// console.log(phanty.height);
// phanty.addTrick("Singing a song!");
// phanty.play();
//
...
//called on our herd. Make sure to store it as a property on the Elephant object. You can populate it with any console.log statement you want to build your parade (e.g. "_______ is trotting by!").
//
// For example:
//
